...
#define SERVER_HOST "dev.sustainablesprinkler.com" //34.201.59.209" //"ec2-34-201-91-4.compute-1.amazonaws.com"//"s-3.us" 
...
#else
#define SERVER_HOST "app.sustainablesprinkler.com" 
